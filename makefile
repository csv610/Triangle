...
CC = cc
CXX = c++
CSWITCHES = -O3 -DNO_TIMER -DANSI_DECLARATORS -I$(SRC)
TRILIBDEFS = -DTRILIBRARY
RM = /bin/rm -f

all: $(BIN)triangle $(BIN)benchmark_hull $(BIN)benchmark_delaunay $(BIN)benchmark_voronoi $(BIN)Triangle.o $(BIN)benchmark_cpp_wrapper
...
$(BIN)benchmark_cpp_wrapper: $(BENCH)benchmark_cpp_wrapper.cpp $(BIN)Triangle.o $(BIN)triangle.o
	$(CXX) $(CSWITCHES) -std=c++11 -o $(BIN)benchmark_cpp_wrapper $(BENCH)benchmark_cpp_wrapper.cpp $(BIN)Triangle.o $(BIN)triangle.o -lm
...
distclean:
	$(RM) $(BIN)triangle $(BIN)triangle.o $(BIN)tricall $(BIN)showme \
		$(BIN)benchmark_hull $(BIN)benchmark_delaunay $(BIN)benchmark_voronoi $(BIN)Triangle.o $(BIN)benchmark_cpp_wrapper
